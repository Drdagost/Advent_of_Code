class Polymerization:
    ...
    def insert_polymer(self, polymer: str, index: int) -> None:
        self.current_template = self.current_template[:index] + polymer + self.current_template[index:]

    def insert_polymers(self) -> None:
        self.current_template = self.polymer_template
        polymers_added = 0
